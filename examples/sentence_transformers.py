...
def predict(to_predict):
    ...
    embeddings_1 = model.encode(sentences_1, batch_size=8, show_progress_bar=True, prompt_name=query_prompt_name)
    embeddings_2 = model.encode(sentences_2, batch_size=8, show_progress_bar=True, prompt_name=query_prompt_name)
